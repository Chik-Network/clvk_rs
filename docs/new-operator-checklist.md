...
2. Assigning meaning to a, previously unknown, operator. Pick an opcode who's
   ...
   [here](https://github.com/Chik-Network/clvk_rs/blob/main/src/more_ops.rs#L156-L182).
...
- Extend the benchmark-clvk-cost.rs to include benchmarks for the new operator,
...
- clvk-fuzzing/src/make_tree.rs has a list of operators, their argument types
