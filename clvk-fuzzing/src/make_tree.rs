...
#[derive(Debug)]
pub struct ArbitraryClvkTree<const MAX_NODES: i64 = 600_000, const REUSE_NODES: bool = true> {
...
impl<'a, const MAX_NODES: i64, const REUSE_NODES: bool> Arbitrary<'a>
    for ArbitraryClvkTree<MAX_NODES, REUSE_NODES>
{
...
fn make_literal_value(
    ...
    let value = match kind {
        ValueKind::Program => make_clvk_program(a, unstructured, inner_env, max_nodes)?,
...
/// returns an arbitrary CLVK tree structure and the number of (unique) nodes
