...
pub fn op_div(a: &mut Allocator, input: NodePtr, max_cost: Cost, flags: ClvkFlags) -> Response {
    ...
    if flags.contains(ClvkFlags::DISABLE_OP) && a0_len > 2048 {
...
pub fn op_gr(a: &mut Allocator, input: NodePtr, _max_cost: Cost, _flags: ClvkFlags) -> Response {
    let [v0, v1] = get_args::<2>(a, input, ">")?;
...
pub fn op_logand(a: &mut Allocator, input: NodePtr, max_cost: Cost, _flags: ClvkFlags) -> Response {
    let v: Number = (-1).into();
...
pub fn op_logior(a: &mut Allocator, input: NodePtr, max_cost: Cost, _flags: ClvkFlags) -> Response {
    let v: Number = 0.into();
...
pub fn op_logxor(a: &mut Allocator, input: NodePtr, max_cost: Cost, _flags: ClvkFlags) -> Response {
    let v: Number = 0.into();
...
mod tests {
    ...
    fn test_large_operand_with_flags() {
        ...
        let cases: &[(&str, Op, u32, u32, ClvkFlags, Option<EvalErr>)] = &[
            ("div", op_div, 8, 2, ClvkFlags::DISABLE_OP, None),
            ("div", op_div, 8, 2, ClvkFlags::MALACHITE, None),
            ("divmod", op_divmod, 8, 2, ClvkFlags::DISABLE_OP, None),
            ("divmod", op_divmod, 8, 2, ClvkFlags::MALACHITE, None),
            ("modulus", op_mod, 8, 2, ClvkFlags::DISABLE_OP, None),
            ("modulus", op_mod, 8, 2, ClvkFlags::MALACHITE, None),
            ("modpow", op_modpow, 8, 3, ClvkFlags::MALACHITE, None),
        ];
    ...
    #[case(true, false, false, ClvkFlags::empty(), false)]
    #[case(false, true, false, ClvkFlags::empty(), false)]
    #[case(false, false, true, ClvkFlags::empty(), false)]
    #[case(true, true, true, ClvkFlags::empty(), false)]
    #[case(true, false, false, ClvkFlags::MALACHITE, false)]
    #[case(false, true, false, ClvkFlags::MALACHITE, false)]
    #[case(false, false, true, ClvkFlags::MALACHITE, false)]
    #[case(true, true, true, ClvkFlags::MALACHITE, false)]
