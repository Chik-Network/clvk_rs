//! CLVK tree interning: deduplicate atoms and pairs in a single pass.
...
/// Result of interning a CLVK tree (deduplicated nodes, unique atoms/pairs).
#[derive(Debug)]
...
/// Intern a CLVK tree: deduplicate atoms and pairs in a single pass.
///
...
/// Intern a CLVK tree using a default unlimited allocator.
