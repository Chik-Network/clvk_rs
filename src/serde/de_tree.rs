...
/// integer values for each clvk object in a tree. It's a port of python code.
///
...
/// parse a serialized clvk object tree to an array of `ParsedTriple` objects
/// This alternative mechanism of deserialization generates an array of
/// references to each clvk object. A reference contains three values:
