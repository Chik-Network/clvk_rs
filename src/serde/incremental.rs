// Serialization with "back-references" of an incrementally built CLVK structure
...
/// The state to allow incrementally serializing CLVK structures with back-refs
