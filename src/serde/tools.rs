...
// computes the tree-hash of a CLVK structure in serialized form
...
/// validate that a buffer is a valid CLVK serialization, and return the length
/// of the CLVK object. This may fail if the serialization contains an invalid
...
ae5c3c40c50832a7aecc0b3ba4646568a00c01289c45e1f03b2b488080808080"
    ...
    #[case("8101")]
    #[case("817f")]
    fn test_clvk_not_canonical_atom(#[case] input: &str) {
    ...
    #[test]
    fn test_clvk_not_canonical_trailing_bytes() {
    ...
    fn test_clvk_canonical(#[case] input: &str, #[case] size: usize) {
