...
use clvk_fuzzing::{make_tree_limits, node_eq};
use clvkr::serde::{node_from_bytes_backrefs, Serializer};
...
fn insert_sentinel(
    ...
    // since CLVK trees are immutable, we have to make a copy of the first part
