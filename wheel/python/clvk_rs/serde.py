"""Serialize and deserialize CLVK in legacy, backref, and 2026 formats.
...
Converting a Python CLVK tree to a Rust-backed LazyNode (with interning):

    from clvk_rs.serde import clvk_tree_to_lazy_node

    lazy = clvk_tree_to_lazy_node(program)
