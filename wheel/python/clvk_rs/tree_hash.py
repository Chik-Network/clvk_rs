...
OP_STACK_F = Callable[[List[CLVKStorage], List[bytes], List["OP_STACK_F"]], None]
...
class Treehasher:
    ...
    def sha256_treehash(self, clvk_storage: CLVKStorage) -> bytes:
        def handle_obj(
            obj_stack: List[CLVKStorage],
            ...
            if r is not None:
                ...
                pair = cast(Tuple[CLVKStorage, CLVKStorage], obj.pair)
                p0, p1 = pair
        ...
        obj_stack: List[CLVKStorage] = [clvk_storage]
