...
binary_recurse('programs/recursive-mul.clvk', '*', '0x7ffffffffffffffffffffffffffffffffffffffffffff', 100)
binary_recurse('programs/recursive-add.clvk', '+', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
binary_recurse('programs/recursive-sub.clvk', '-', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
